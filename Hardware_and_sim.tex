	...
	\begin{figure}
		\begin{centering}
			\begin{tikzpicture}
				...
				\end{feynman}
			\end{tikzpicture}
			\caption{ $p+p\rightarrow gq \left(\bar{q} \right) + X$ events, these dijet-types are possible only via quark (antiquark) and gluon interactions, hence probing both gluon and quark distributions at once}
