...
\section{Calorimetery}
	...
	\subsection{Hadronic Calorimeters}
		...
		Each tower corresponds to a readout board that sums readout from four scintillator paddles in the inner HCAL and five scinitillator paddles in the outer HCAL embeded into the calorimeter as show in fig. \ref{fig:hcal}. 
	...
	\subsection{Electromagnetic Calorimeter}
		...
		\subsubsection{Calibration}
			...
			The mean $m_{\pi^0}$ and width are used as quality assurance plots to monitor radiation damage to the EMCal on an ongoing baisis and provide updated calibrations throughout the runs.
...
\section{Tracking}
	...
	However, this thesis does not make use of the tracking data as track to calorimeter matching is still undergoing developement at the time of this analysis, thus the tracking detectors are briefly mentioned here but are not expanded upon in detail
	\subsection{Time Projection Chamber}
	The Time Projection Chamber (TPC) is a gas based detector designed to track charged particles through drift 
	\subsection{TPC Outer Tracker}
	Breaking with the established convention, the next detector is found at larger radial distnace from the interaction point than the TPC. The TPC Outer Tracker (TPOT) was designed as a minimal add-on to improve tracking effeciency and resolution by providing additional track points. 
