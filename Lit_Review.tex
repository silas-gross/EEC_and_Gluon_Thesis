...
\subsubsection{Cone Methods}
	...
	This discrepancy proves useful in analysis of jet substructure observables, such as the primary family of observables--the Energy-Energy Correlatora--in this thesis, as it allows for a lund Plane analysis of the jet structure that combines anti-$k_T$ and $k_{T}$ techniques to improve veracity of the analysis method %cite something here about the Lund Plane
...
\subsection{Quark and Gluon Jets}	
	...
	Experimentally, there is significant interest in being able to discriminate quark and gluon jets in searches for Beyond Standard Model physics, searches for Dark Matter, in jet substructure analysis and in QGP physics. \cite{Gallicchio2011}\cite{Lima2017}\cite{Bhattacherjee2017}\cite{}. 
	 ...
	 As one would expect, Fodor notes that the underlying assumption is that "jets are the footprints of the partons....Thus we should detemine the parotn ancestor of a jet" \cite{Fodor1990}. 
	 From here, Fodor goes on to note signifigant distinuishing characteristics of the parton populations, noting the gluon has a stronger color charge and is of spin-1 as compared to the spin-half quark, and that this color charge is reflected in the comparative fragementations, inducing higher multilicity, softer hadron spectrum and a broader $p_T$ spectrum. 
	 ...
	 Further, Fodor notes that the observable of intrest must supress the "'problematic' soft particle [contribution]" and be dependent on the energy of the jet.
	 ...
	 One can not draw a Feynman diagram of a jet, nor will any combination of quark and gluon veritices ever lead to a final state with no free partons present. 
	 This defficiency is even seen in the observational challenges noted by Fodor, where, the assigning of soft particles to one jet or the other becomes a problematic task for the analyzer and the particular jet algorithm and energy must be carefully tuned for the two styles. 
	 It is these deficiencies that, while not insurmountable, would lead one to seek a more phenomonologially pleasing definition. 
